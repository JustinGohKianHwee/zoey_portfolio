...
export const projects: Project[] = [
  {
    ...
    year: '2026',
    course: 'AR5806 Options Design Research Studio 3',
    institution: 'National University of Singapore',
    professor: '[needs Zoey input — professor name]',
    location: 'Singapore',
    ...
    concept: '[needs Zoey input — concept statement for ReHarvest]',
    overview: `[needs Zoey input — project description for ReHarvest]

[needs Zoey input — further description]`,
    ...
    images: [
      {
        ...
        type: 'diagram',
        layout: 'half',
        annotation: '[needs Zoey input — write-up for programme zoning]',
      },
      {
        ...
        type: 'diagram',
        layout: 'half',
        annotation: '[needs Zoey input — write-up for cultivation performance]',
      },
      {
...
The result is an envelope layer that responds to Singapore's equatorial climate by providing shade when the sun is high, channelling cross-ventilation when wind conditions allow, and maintaining visual connection to the landscape. Designed in collaboration with Ng Guang Ze.`,
...

  {
    ...
    featured: false,
    order: 7,
    heroImage: '/images/projects/diverging-paths/perspective-1.png',
    thumbnailImage: '/images/projects/diverging-paths/perspective-1.png',
    concept:
...
The ground floor plan and emotive section document the building's spatial narrative: the way natural light falls between volumes, the way movement through the building oscillates between exposure and enclosure. The emotive section translates the film's tonal arc into architectural cross-section — from the tight private spaces at the building's edges to the open communal heart at its centre.`,
    ...
    images: [
      ...
      {
        src: '/images/projects/diverging-paths/partial-section.png',
        alt: 'Partial section',
        caption: 'Partial section',
        type: 'section',
        layout: 'half',
      },
      {
        src: '/images/projects/diverging-paths/perspective-2.png',
        alt: 'Perspective view 2',
        caption: '',
        type: 'render',
        layout: 'half',
      },
      {
        src: '/images/projects/diverging-paths/perspective-3.png',
        alt: 'Perspective view 3',
        caption: '',
        type: 'render',
        layout: 'half',
      },
